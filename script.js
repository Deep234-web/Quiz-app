...
function checkAnswer() {
    ...
    if (selectedAnswer === correctAnswer) {
      ...
      <img src="https://wallpaperplay.com/walls/full/b/9/9/15299.jpg" id='correct_Answer' alt= 'correctAnswerIcon'/>
      ...
      $('.js-quiz').html(`<div class = 'badAnswer'><p>Nope! That's not Right. Correct answer is "${correctAnswer}."</p><img src= "https://wallpaperplay.com/walls/full/1/d/7/15261.jpg" id='wrong_Answer' alt= 'wrongAnswerIcon'/><button id='nextQ'>Next</button></div>`);
    }
...
function showResults() {
  ...
  $('.js-quiz').html(`<div class='resultPage'><h2>You finished the QUIZ and That's very good</h2><img src="finishing test.jpg" alt= 'very-good' id = 'lastImage'/><button type = 'restart' id = 'restartButton'>Restart</button></div>`);
      ...
      <img src="https://wallpaperplay.com/walls/full/f/e/3/15253.jpg" alt= 'not-bad' id = 'lastImage'/>
      ...
      <img src="https://wallpaperplay.com/walls/full/2/f/c/15269.jpg" alt= 'really-bad' id = 'lastImage'/>
      <button type = 'restart' id = 'restartButton'>Restart</button></div>`);
  }
} 
